...
class ProfileFragment : Fragment() {
    ...
    private var isOpeningSelf: Boolean = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            ...
            isOpeningSelf = arguments!!.getBoolean("isOpeningSelf")
        }
    }
    ...
    override fun onResume() {
        ...
        profileViewModel.getInfo()
                ...
                .subscribe({ subject: Subject ->
                    profileViewModel.loadProfileImage(profileImage, 256, true)
    ...
    companion object {
        @JvmStatic
        fun newInstance(birthId: String, isOpeningSelf: Boolean) =
                ProfileFragment().apply {
                    arguments = Bundle().apply {
                        this.putString("birthId", birthId)
                        this.putBoolean("isOpeningSelf", isOpeningSelf)
                    }
                }
    }
}