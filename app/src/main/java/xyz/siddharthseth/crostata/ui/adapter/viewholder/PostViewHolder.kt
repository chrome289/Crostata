...
class PostViewHolder(
    ...
    fun execute(feedPost: FeedPost) {
        binding.constraintLayoutFeedPostCard.setOnClickListener {
            val intent: Intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("crostata://siddharthseth.xyz/post/@y"))
        ...
        val pattern = Pattern.compile("@[(aA-zZ)(0-9)(_.)]+")
        val scheme = "crostata://siddharthseth.xyz/user/"
        Linkify.addLinks(binding.textViewFeedPostContent, pattern, scheme)
